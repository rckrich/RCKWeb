    ...
    <div class="container">
        ...
        <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" name="banner_img_url" id="banner_img_url" class="form-control-file">
            ...
            <div class="form-group">
                ...
                <input type="file" name="icon_url" id="icon_url" class="form-control-file">
            ...
            <div class="form-group">
                ...
                <input type="date" name="creation_date" id="creation_date" class="form-control" value="{{ $project->creation_date }}">
            </div>
